...
wget "https://github.com/keptn/keptn/releases/download/${KEPTN_VERSION}/keptn-${KEPTN_VERSION}.tgz"

keptn add-resource --project=${KEPTN_PROJECT} --service=keptn --all-stages --resource=keptn-${KEPTN_VERSION}.tgz --resourceUri=helm.tgz